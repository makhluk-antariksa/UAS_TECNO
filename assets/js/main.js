...
// Ditambah variasi bank per kecamatan supaya tabel tidak kosong
const bankSampahData = [
    ...
    // Tambahan data agar tabel terisi penuh
    { id: 15, kecamatan: 'Umbulharjo', nama: 'Bank Sampah Melati', kapasitas: 68, status: 'safe' },
    { id: 16, kecamatan: 'Gondokusuman', nama: 'Bank Sampah Pugeran', kapasitas: 72, status: 'warning' },
    { id: 17, kecamatan: 'Jetis', nama: 'Bank Sampah Tugu Hijau', kapasitas: 81, status: 'warning' },
    { id: 18, kecamatan: 'Mergangsan', nama: 'Bank Sampah Lempuyangan', kapasitas: 58, status: 'safe' },
    { id: 19, kecamatan: 'Danurejan', nama: 'Bank Sampah Wijaya Kusuma', kapasitas: 64, status: 'safe' },
    { id: 20, kecamatan: 'Gedongtengen', nama: 'Bank Sampah Malioboro Berseri', kapasitas: 83, status: 'warning' },
    { id: 21, kecamatan: 'Ngampilan', nama: 'Bank Sampah Sonosewu', kapasitas: 91, status: 'overload' },
    { id: 22, kecamatan: 'Wirobrajan', nama: 'Bank Sampah Kalih Rejeki', kapasitas: 47, status: 'safe' },
    { id: 23, kecamatan: 'Mantrijeron', nama: 'Bank Sampah Brontokusuman', kapasitas: 74, status: 'warning' },
    { id: 24, kecamatan: 'Kraton', nama: 'Bank Sampah Alun-Alun Kidul', kapasitas: 52, status: 'safe' },
    { id: 25, kecamatan: 'Pakualaman', nama: 'Bank Sampah Sentolo', kapasitas: 89, status: 'overload' },
    { id: 26, kecamatan: 'Tegalrejo', nama: 'Bank Sampah Sinduadi', kapasitas: 66, status: 'safe' },
    { id: 27, kecamatan: 'Kotagede', nama: 'Bank Sampah Prenggan', kapasitas: 79, status: 'warning' },
    { id: 28, kecamatan: 'Gondomanan', nama: 'Bank Sampah Bintaran', kapasitas: 57, status: 'safe' }
];
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Event listener untuk smooth scroll pada anchor links
